...
#define MHU_MOUSE_LLT  KC_MS_WH_LEFT
#define MHU_MOUSE_LRT  KC_MS_WH_UP
#define MHU_MOUSE_LMT  KC_MS_WH_DOWN
#define MHU_MOUSE_LIT  KC_MS_WH_RIGHT
#define MHU_MOUSE_LIIT KC_NO
#define MHU_MOUSE_RIIT KC_NO
#define MHU_MOUSE_RIT  KC_MS_WH_LEFT
#define MHU_MOUSE_RMT  KC_MS_WH_DOWN
#define MHU_MOUSE_RRT  KC_MS_WH_UP
#define MHU_MOUSE_RLT  KC_MS_WH_RIGHT
#define MHU_MOUSE_ROLT KC_NO
#define MHU_MOUSE_LOLH TO(MHU_NUM)
#define MHU_MOUSE_LLH  MHU_LGUI
#define MHU_MOUSE_LRH  MHU_LALT
#define MHU_MOUSE_LMH  MHU_LCTL
#define MHU_MOUSE_LIH  MHU_LSFT
...
#define MHU_MOUSE_LLB  QK_LOCK
#define MHU_MOUSE_LRB  KC_MS_BTN2
#define MHU_MOUSE_LMB  KC_MS_BTN3
#define MHU_MOUSE_LIB  KC_MS_BTN1
