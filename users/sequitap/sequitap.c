...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch(keycode) {
    ...
    PROCESS_RECORD_CASE(WHU_RMOD_RITH, KC_NO, WHU_BASE)
        ...
        PROCESS_RECORD_CASE(WHU_FUN_RIIT, WHU_SCRL, WHU_BASE)
        ...
        PROCESS_RECORD_CASE(WHU_FUN_RIIH, WHU_PSCR, WHU_BASE)
        ...
        PROCESS_RECORD_CASE(WHU_FUN_RIIB, WHU_PAUS, WHU_BASE)
