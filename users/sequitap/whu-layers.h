...
#define WHU_MOUSE_LLT  KC_MS_WH_RIGHT
#define WHU_MOUSE_LRT  KC_MS_WH_UP
#define WHU_MOUSE_LMT  KC_MS_WH_DOWN
#define WHU_MOUSE_LIT  KC_MS_WH_LEFT
#define WHU_MOUSE_LIIT KC_NO
#define WHU_MOUSE_RIIT KC_NO
#define WHU_MOUSE_RIT  KC_NO
#define WHU_MOUSE_RMT  KC_NO
#define WHU_MOUSE_RRT  KC_NO
#define WHU_MOUSE_RLT  KC_NO
#define WHU_MOUSE_ROLT KC_NO
#define WHU_MOUSE_LOLH TO(WHU_NUM)
#define WHU_MOUSE_LLH  KC_MS_BTN4
#define WHU_MOUSE_LRH  KC_MS_BTN3
#define WHU_MOUSE_LMH  KC_MS_BTN2
#define WHU_MOUSE_LIH  KC_MS_BTN1
...
#define WHU_MOUSE_LLB  KC_MS_BTN8
#define WHU_MOUSE_LRB  KC_MS_BTN7
#define WHU_MOUSE_LMB  KC_MS_BTN6
#define WHU_MOUSE_LIB  KC_MS_BTN5
