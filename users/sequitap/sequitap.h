...
#define RECORD_CASES(PREFIX) \
    ...
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LLT, PREFIX##_APP, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LRT, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LMT, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LIT, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LIIT, KC_NO, last_permanent_layer) \
    ...
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LLB, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LRB, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LMB, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LIB, KC_NO, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_LMOD_LIIB, KC_NO, last_permanent_layer) \
    ...
    PROCESS_RECORD_CASE(PREFIX##_RMOD_RIT, PREFIX##_DEL, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_RMOD_RMT, PREFIX##_ENT, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_RMOD_RRT, PREFIX##_TAB, last_permanent_layer) \
    PROCESS_RECORD_CASE(PREFIX##_RMOD_RLT, PREFIX##_ESC, last_permanent_layer) \
    ...
    PROCESS_RECORD_CASE(PREFIX##_FUN_LOLB, KC_NO, PREFIX##_FUN) \
    ...
    PROCESS_RECORD_CASE(PREFIX##_FUN_ROLB, KC_NO, PREFIX##_FUN) \
