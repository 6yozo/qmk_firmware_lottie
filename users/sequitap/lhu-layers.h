...
#define LHU_MOUSE_LLT  KC_MS_WH_RIGHT
#define LHU_MOUSE_LRT  KC_MS_WH_UP
#define LHU_MOUSE_LMT  KC_MS_WH_DOWN
#define LHU_MOUSE_LIT  KC_MS_WH_LEFT
#define LHU_MOUSE_LIIT KC_NO
#define LHU_MOUSE_RIIT KC_NO
#define LHU_MOUSE_RIT  KC_NO
#define LHU_MOUSE_RMT  KC_NO
#define LHU_MOUSE_RRT  KC_NO
#define LHU_MOUSE_RLT  KC_NO
#define LHU_MOUSE_ROLT KC_NO
#define LHU_MOUSE_LOLH TO(LHU_NUM)
#define LHU_MOUSE_LLH  KC_MS_BTN4
#define LHU_MOUSE_LRH  KC_MS_BTN3
#define LHU_MOUSE_LMH  KC_MS_BTN2
#define LHU_MOUSE_LIH  KC_MS_BTN1
...
#define LHU_MOUSE_LLB  KC_MS_BTN8
#define LHU_MOUSE_LRB  KC_MS_BTN7
#define LHU_MOUSE_LMB  KC_MS_BTN6
#define LHU_MOUSE_LIB  KC_MS_BTN5
