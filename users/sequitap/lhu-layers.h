...
#define LHU_HBDC_ROLH TO(LHU_NUM)
#define LHU_HBDC_LOLB TO(LHU_FUN)
...
#define LHU_HBDC_RLB  QK_REP
#define LHU_HBDC_ROLB TO(LHU_FUN)
...
#define LHU_NAV_LOLT KC_NO
#define LHU_NAV_LLT  LHU_ESC
#define LHU_NAV_LRT  LHU_TAB
#define LHU_NAV_LMT  LHU_ENT
#define LHU_NAV_LIT  LHU_DEL
#define LHU_NAV_LIIT LHU_N0
#define LHU_NAV_RIIT LHU_INS
#define LHU_NAV_RIT  KC_NO
#define LHU_NAV_RMT  KC_NO
#define LHU_NAV_RRT  KC_NO
#define LHU_NAV_RLT  KC_NO
#define LHU_NAV_ROLT KC_NO
#define LHU_NAV_LOLH TO(LHU_NUM)
#define LHU_NAV_LLH  LHU_LEFT
#define LHU_NAV_LRH  LHU_UP
#define LHU_NAV_LMH  LHU_DOWN
#define LHU_NAV_LIH  LHU_RIGHT
#define LHU_NAV_LIIH LHU_CAPS
#define LHU_NAV_RIIH QK_LOCK
#define LHU_NAV_RIH  LHU_LSFT
#define LHU_NAV_RMH  LHU_LCTL
#define LHU_NAV_RRH  LHU_LALT
#define LHU_NAV_RLH  LHU_LGUI 
#define LHU_NAV_ROLH TO(LHU_NUM)
#define LHU_NAV_LOLB TO(LHU_FUN)
#define LHU_NAV_LLB  LHU_HOME
#define LHU_NAV_LRB  LHU_PGUP
#define LHU_NAV_LMB  LHU_PGDN
#define LHU_NAV_LIB  LHU_END
#define LHU_NAV_LIIB KC_NO
#define LHU_NAV_RIIB LHU_DELWORD
#define LHU_NAV_RIB  KC_NO
#define LHU_NAV_RMB  KC_NO
#define LHU_NAV_RRB  KC_NO
#define LHU_NAV_RLB  KC_NO
#define LHU_NAV_ROLB TO(LHU_FUN)
...
#define LHU_NPAD_ROLH TO(LHU_NUM)
#define LHU_NPAD_LOLB TO(LHU_FUN)
...
#define LHU_NPAD_RMB  LHU_LPAR
#define LHU_NPAD_RRB  LHU_RPAR
#define LHU_NPAD_RLB  LHU_PDOT
#define LHU_NPAD_ROLB TO(LHU_FUN)
...
#define LHU_MOUSE_LOLT KC_NO
#define LHU_MOUSE_LLT  KC_MS_WH_LEFT
#define LHU_MOUSE_LRT  KC_MS_WH_UP
#define LHU_MOUSE_LMT  KC_MS_WH_DOWN
#define LHU_MOUSE_LIT  KC_MS_WH_RIGHT
#define LHU_MOUSE_LIIT KC_NO
#define LHU_MOUSE_RIIT KC_NO
#define LHU_MOUSE_RIT  KC_MS_WH_LEFT
#define LHU_MOUSE_RMT  KC_MS_WH_DOWN
#define LHU_MOUSE_RRT  KC_MS_WH_UP
#define LHU_MOUSE_RLT  KC_MS_WH_RIGHT
#define LHU_MOUSE_ROLT KC_NO
#define LHU_MOUSE_LOLH TO(LHU_NUM)
#define LHU_MOUSE_LLH  LHU_LGUI
#define LHU_MOUSE_LRH  LHU_LALT
#define LHU_MOUSE_LMH  LHU_LCTL
#define LHU_MOUSE_LIH  LHU_LSFT
#define LHU_MOUSE_LIIH KC_NO
#define LHU_MOUSE_RIIH KC_NO
#define LHU_MOUSE_RIH  KC_MS_LEFT
#define LHU_MOUSE_RMH  KC_MS_DOWN
#define LHU_MOUSE_RRH  KC_MS_UP
#define LHU_MOUSE_RLH  KC_MS_RIGHT
#define LHU_MOUSE_ROLH TO(LHU_NUM)
#define LHU_MOUSE_LOLB TO(LHU_FUN)
#define LHU_MOUSE_LLB  QK_LOCK
#define LHU_MOUSE_LRB  KC_MS_BTN2
#define LHU_MOUSE_LMB  KC_MS_BTN3
#define LHU_MOUSE_LIB  KC_MS_BTN1
#define LHU_MOUSE_LIIB KC_NO
#define LHU_MOUSE_RIIB KC_NO
#define LHU_MOUSE_RIB  KC_NO
#define LHU_MOUSE_RMB  KC_NO
#define LHU_MOUSE_RRB  KC_NO
#define LHU_MOUSE_RLB  KC_NO
#define LHU_MOUSE_ROLB TO(LHU_FUN)
#define LHU_MOUSE_LITH TO(LHU_LMOD)
#define LHU_MOUSE_LTH  LHU_HBDC_LTH
#define LHU_MOUSE_LOTH TO(SYSTEM)
#define LHU_MOUSE_ROTH LHU_BSPC
#define LHU_MOUSE_RTH  LHU_SPACE
#define LHU_MOUSE_RITH TO(LHU_RMOD)
