...
#define MHU_NAV_LMH  MHU_LCTL
#define MHU_NAV_LIH  MHU_LSFT
#define MHU_NAV_LIIH KC_NO
#define MHU_NAV_RIIH MHU_CAPS
#define MHU_NAV_RIH  MHU_LEFT
...
#define MHU_NAV_LIB  MHU_PASTE
#define MHU_NAV_LIIB MHU_AGAIN
#define MHU_NAV_RIIB MHU_DELWORD
#define MHU_NAV_RIB  MHU_HOME
